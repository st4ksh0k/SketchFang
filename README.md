...
**Copy a Sketchfab link. Paste it. Get a `.glb`.**

### 1. Get the link

Open any model on [sketchfab.com](https://sketchfab.com) and copy the URL from your browser’s address bar. Any of these work:

```
https://sketchfab.com/3d-models/cool-robot-a1b2c3d4e5f6789012345678abcdef01
https://sketchfab.com/models/a1b2c3d4e5f6789012345678abcdef01/embed
a1b2c3d4e5f6789012345678abcdef01
```

SketchFang pulls the 32-character model UID out of the string — you don’t have to trim anything.

### 2. Install (once)

```bash
git clone https://github.com/st4ksh0k/SketchFang.git
cd SketchFang
python3 -m venv .venv
...
```bash
python3 -m sketchfang "https://sketchfab.com/3d-models/cool-robot-a1b2c3d4e5f6789012345678abcdef01" -o ./out
```

When it finishes, open `./out/<model-name>/<model-name>.glb` in Blender, Windows 3D Viewer, or any glTF viewer.

**That’s it.** Everything below is for people who want to know *how* the sausage gets decrypted.
